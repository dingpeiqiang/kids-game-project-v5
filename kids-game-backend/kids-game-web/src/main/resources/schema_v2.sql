...
) ENGINE=InnoDB AUTO_INCREMENT=973 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='疲劳点日志表';
...
CREATE TABLE `t_user_control_config` (
                                         ...
                                         `fatigue_control_mode` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'SOFT' COMMENT '疲劳控制模式：SOFT-软模式，HARD-硬模式，OFF-关闭',
                                         ...
                                         `fatigue_point_threshold` int DEFAULT '60' COMMENT '疲劳点阈值（分钟）',
