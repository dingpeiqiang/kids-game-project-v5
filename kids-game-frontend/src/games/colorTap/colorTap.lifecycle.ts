...
import { runCanvasLifecycle, type GameLifecycle } from '@shell/platform/GameLifecycle'
...
import { resolveGtrsCanvasStyle, type GtrsCanvasStyle } from '@shell/utils/gtrsCanvasTheme'
