...
import { resizeCanvasForMobile, injectMobileStyles } from '@shell/utils/mobileHelper'
...
const lifecycle = createCanvasGameLifecycle('jewelMatch', startJewelMatchLifecycle)

export const initJewelMatch = lifecycle.init
export const destroyJewelMatch = lifecycle.destroy
