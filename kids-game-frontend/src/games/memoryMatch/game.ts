...
import { resizeCanvasForMobile } from '@shell/utils/mobileHelper'
...
const lifecycle = createCanvasGameLifecycle('memoryMatch', startMemoryMatchLifecycle)

export const initMemoryMatch = lifecycle.init
export const destroyMemoryMatch = lifecycle.destroy
