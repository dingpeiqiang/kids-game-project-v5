...
export const TURRET_CONFIGS: Record<string, TurretConfig> = {
  laser: {
    ...
    damage: 12,
    fireRate: 180,
    range: 180,  // 增加攻击范围：130 -> 180
    hp: 50,
    targetPriority: 'nearest',
    upgradePath: [
      { level: 2, cost: 60, damage: 20, fireRate: 160, range: 210 },  // Lv2: 210
      { level: 3, cost: 120, damage: 32, fireRate: 130, range: 250, special: '穿透' }  // Lv3: 250
    ]
  },
  missile: {
    cost: 80,
    damage: 35,
    fireRate: 1200,
    range: 220,  // 增加攻击范围：160 -> 220
    hp: 80,
    targetPriority: 'strongest',
    special: '范围爆炸',
    upgradePath: [
      { level: 2, cost: 120, damage: 55, fireRate: 1000, range: 260 },  // Lv2: 260
      { level: 3, cost: 240, damage: 90, fireRate: 800, range: 300, special: '追踪导弹' }  // Lv3: 300
    ]
  },
  frost: {
    cost: 50,
    damage: 8,
    fireRate: 400,
    range: 170,  // 增加攻击范围：120 -> 170
    hp: 60,
    targetPriority: 'first',
    special: '减速50%',
    upgradePath: [
      { level: 2, cost: 80, damage: 12, fireRate: 350, range: 200 },  // Lv2: 200
      { level: 3, cost: 160, damage: 18, fireRate: 280, range: 240, special: '短暂冻结' }  // Lv3: 240
    ]
  },
  lightning: {
    cost: 120,
    damage: 25,
    fireRate: 700,
    range: 200,  // 增加攻击范围：140 -> 200
    hp: 70,
    targetPriority: 'nearest',
    special: '连锁x3',
    upgradePath: [
      { level: 2, cost: 180, damage: 40, fireRate: 580, range: 240 },  // Lv2: 240
      { level: 3, cost: 320, damage: 65, fireRate: 450, range: 280, special: '连锁x5' }  // Lv3: 280
    ]
  }
}
