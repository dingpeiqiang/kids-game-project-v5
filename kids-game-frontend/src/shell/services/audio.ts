...
export class AudioService {
  ...
  transform = () => {
    // 变身音效：“唰——”机械变形音效
    this.rise(300, 1200, 0.3, 'sine', 0.12)
    setTimeout(() => this.playTone(1500, 0.15, 'triangle', 0.1), 150)
    setTimeout(() => this.playNoise(0.1, 0.08), 100)
  }
  ...
  nearMiss = () => {
    ...
    setTimeout(() => this.playTone(1000, 0.05, 'sine', 0.1), 40)
  }
  
  magnetActive = () => {
    // 磁铁激活音效：吸引的嗡嗡声
    this.rise(200, 600, 0.2, 'sine', 0.08)
    setTimeout(() => this.playTone(800, 0.1, 'triangle', 0.06), 150)
  }
  ...
  invincibleActive = () => {
    // 无敌模式音效：强大的能量音
    this.rise(400, 1000, 0.25, 'sine', 0.12)
    setTimeout(() => this.playTone(1200, 0.15, 'triangle', 0.1), 200)
  }
}
