...
import { getGameRegistration, destroyGame, initGame } from '@/games/gameRegistry';
...
import { gameEngine } from '@shell/services/gameEngine';
import {
  mountMainGameCanvas,
  resolveGameViewport,
  ...
  type GameViewport,
} from '@shell/services/canvasGameRuntime';
import { OrientationManager } from '@shell/utils/orientation';
import { storageService } from '@shell/services/storage';
import { userService } from '@shell/services/userService';
import GameGuideOverlay from '@shell/components/GameGuideOverlay.vue';
import GamePlayShellHeader from '@shell/components/game-play/GamePlayShellHeader.vue';
import GamePlayResultPanel from '@shell/components/game-play/GamePlayResultPanel.vue';
import GamePlayPauseOverlay from '@shell/components/game-play/GamePlayPauseOverlay.vue';
import { prepareEmbeddedCanvasPlay } from '@shell/services/embeddedGameLaunch';
import {
  installGameEventBridge,
  uninstallGameEventBridge,
  setGameEndHandler,
} from '@shell/platform';
import { useCanvasGameSession } from '@shell/composables/useCanvasGameSession';
...
} from '@shell/app/gameShellOrientation';
import { LOBBY_HOME_PATH, navigateToLobbyHome } from '@shell/router/navigation';
import { calculateRank } from '@shell/app/rank';
import type { GameResultStats } from '@shell/types/gameResult';
