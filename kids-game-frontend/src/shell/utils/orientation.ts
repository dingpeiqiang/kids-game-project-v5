/** Screen Orientation API lock（非所有 TS lib 都包含） */
type LockableScreenOrientation = ScreenOrientation & {
  lock: (orientation: string) => Promise<void>
  unlock: () => void
}

function getLockableOrientation(): LockableScreenOrientation | null {
  const o = screen.orientation as LockableScreenOrientation | undefined
...
export class OrientationManager {
  ...
  public supportsOrientationLock(): boolean {
    return getLockableOrientation() != null
  }
