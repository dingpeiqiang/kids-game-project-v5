...
transform: translateX(-50%);
    ...
    const login = (secret) => {
      ...
      grecaptcha.ready(() => {
        grecaptcha.execute(configData.CAPTCHASITE, { action: "relogin" }).then((thetoken) => {
    ...
    var createButtons = () => {
      ...
      this.loginButton = new ImgButton(this, this.canvas.width - (this.canvas.width > 610 ? 300 : 100), 0, "loginbtn", () => {
        ...
        this.login.getChildByName("login").onclick = () => {
          grecaptcha.ready(() => {
            grecaptcha.execute(configData.CAPTCHASITE, { action: "login" }).then((thetoken) => {
      ...
      this.signupButton = new ImgButton(this, this.canvas.width - (this.canvas.width > 610 ? 300 : 100), 0, "signupbtn", () => {
        ...
        this.signup.getChildByName("signup").onclick = () => {
          grecaptcha.ready(() => {
            grecaptcha.execute(configData.CAPTCHASITE, { action: "signup" }).then((thetoken) => {
