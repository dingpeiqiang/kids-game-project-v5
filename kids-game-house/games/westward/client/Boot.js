...
var Boot = new Phaser.Class({
    ...
    displayButton: function(){
        ...
        if(Client.gameConfig && Client.gameConfig.boot && Client.gameConfig.boot.offerTutorial) {
            Boot.buttons.push(new BigButton(512, 450, 'Tutorial', UI.launchTutorialMode,true));
        }
