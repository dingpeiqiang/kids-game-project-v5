...
const ABLY_DISABLED = !ABLY_API_KEY || ABLY_API_KEY === 'disabled' || ABLY_API_KEY === 'your_ably_api_key_here';
...
// instantiate to Ably only if enabled
if (!ABLY_DISABLED) {
...
if (!ABLY_DISABLED && realtime) {
  ...
  console.log('⚠️  Worker thread: Ably disabled - single-player mode');
}
