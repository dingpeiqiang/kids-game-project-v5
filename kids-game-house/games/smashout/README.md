...
## 🚀 Now powered by Vite!
This project has been optimized with Vite for faster development and better performance.
...
npm i
```
4. Start local development server (using Vite)
```
npm run dev
```
The game will open automatically at http://localhost:3006
