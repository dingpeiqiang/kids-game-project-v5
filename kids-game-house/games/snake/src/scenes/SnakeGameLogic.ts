...
export class SnakeGameLogic {
  ...
  /** 当前食物对象 */
  private currentFood: Position | null = null
   ...
   */
  public spawnFood(minCount: number = 1, maxCount: number = 1): void {
  ...
  private onFoodEaten(): void {
    ...
    console.log(`🎉 [SnakeGameLogic] 吃到食物！分数：${this.score}`)
   ...
   * 获取当前食物位置
   */
  public getCurrentFood(): Position | null {
