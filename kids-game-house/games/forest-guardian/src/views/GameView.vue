<template>
  <div class="game-view w-full h-full relative overflow-hidden">
    ...
    <!-- Top-Down RPG UI -->
    <div v-if="isReady" class="absolute top-16 left-4 z-30 flex gap-4">
      <HeroStatus 
      ...
      <!-- 分数显示 -->
      <div class="bg-black/60 text-white px-4 py-2 rounded border-2 border-yellow-400 font-mono text-xl shadow-lg flex items-center">
