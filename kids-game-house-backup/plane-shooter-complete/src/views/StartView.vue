<template>
  <div class="w-full h-full flex flex-col items-center justify-center px-4 fade-in relative" :style="containerStyle">
    ...
    <div class="text-center mb-8" :style="titleContainerStyle">
      ...
      <h2 class="font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400" :style="titleStyle">
        飞机大战
      </h2>
      <p class="text-gray-400 mt-4" :style="subtitleStyle">经典纵向卷轴射击游戏</p>
    </div>
