...
const buildContext = (): PlatformContext => {
  return {
    get currentGame() { return currentGame.value },
    set currentGame(v) { currentGame.value = v },
    get rankCache() { return new Map() },
    get currentPage() { return currentPage.value },
    set currentPage(v) { currentPage.value = v },
    get searchKeyword() { return searchKeyword.value },
    set searchKeyword(v) { searchKeyword.value = v },
    get previewAnimFrames() { return previewAnimFrames.value },
    get previewObserver() { return previewObserver.value },
    set previewObserver(v) { previewObserver.value = v },
    get selectedRating() { return selectedRating.value },
